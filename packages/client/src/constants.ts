...
/**
 * 检查器 DOM 元素标识，用于定位页面中的编辑器检查器根节点
 */
...
/**
 * 是否处于浏览器环境，用于区分服务端渲染场景
 */
export const IS_CLIENT = typeof window !== 'undefined';

/**
 * 是否 Firefox 浏览器，用于处理浏览器特定兼容逻辑
 */
...
/**
 * 当前检查会话 ID，生成规则：8 位 16 进制随机数，保证同页面多实例隔离
 */
